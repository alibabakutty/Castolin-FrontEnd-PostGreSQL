...
const useOrderSubmission = ({ 
  ...
  }, [orderData, editingRow, customerName, isDistributorRoute]);
  ...
  }, [orderData, status, voucherType, date, customerName, distributorUser, 
      executiveName, totals, orderNumber, remarks, onSuccess, onError]);
  ...
  }, [orderData, editingRow, orderNumber, date, customerName, distributorUser, 
      remarks, isDirectRoute, isDistributorRoute, isTamilNaduState, totals, 
      onSuccess, onError]);
  ...
  }, [isSubmitting, validateOrder, mode, handleUpdate, handleCreate, onReset, validationErrors]);
